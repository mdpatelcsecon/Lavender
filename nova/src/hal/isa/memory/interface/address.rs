...
pub trait VirtualAddress: Copy + Clone + Debug + PartialEq + Eq + PartialOrd + Ord
...
pub trait PhysicalAddress: Copy + Clone + Debug + PartialEq + Eq + PartialOrd + Ord + From<usize> + Into<usize>
{
