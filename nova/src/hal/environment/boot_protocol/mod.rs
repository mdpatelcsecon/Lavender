...
//! of ARM SystemReady program.
//!
//! Systems that do not meet the aforementioned requirements are not supported and will never be supported in line with
//! the philosophy of this project to exclusively support and actively encourage the proliferation of standardized
//! systems. Please do not open issues or PRs requesting or implementing support for non-standardized systems. They will
//! be rejected. If you would like support on a given device please contact the manufacturer and request that they
//! provide support for ARM SystemReady compliant firmware.
